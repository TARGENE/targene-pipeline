...
- `PREVALENCE` : The prevalence of a binary trait in the population from which the observations used for analysis were sampled. Must be a float greater than 0 and less than 1. Currently the prevalence option only supports the analysis of one trait.
